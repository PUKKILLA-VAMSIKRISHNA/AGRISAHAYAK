...
def setup_app(app):
    with app.app_context():
        ...
        protected_api_test_translation = login_required(api_test_translation)
        ...
        if db_initialized:
            ...
            app.add_url_rule('/api/test_translation', 'api_test_translation', protected_api_test_translation, methods=['GET'])
            ...
            app.add_url_rule('/api/test_translation', 'api_test_translation', maintenance_route, methods=['GET'])
